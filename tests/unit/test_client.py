...
from openrouter_inspector.models import ModelInfo, ProviderInfo, ProviderDetails
...
class TestOpenRouterClient:
    ...
    @pytest.mark.asyncio
    async def test_get_models_success(self, config, sample_models_response, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_get_models_alternative_response_format(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_get_models_invalid_data(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_get_model_providers_success(self, config, sample_providers_response, httpx_mock):
        """Test successful provider retrieval."""
        httpx_mock.add_response(
            method="GET",
            url="https://openrouter.ai/api/v1/models/openai/gpt-4/providers",
    ...
    @pytest.mark.asyncio
    async def test_get_model_providers_fallback_to_models_endpoint(self, config, sample_models_response, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_get_model_providers_model_not_found(self, config, httpx_mock):
        """Test provider retrieval for non-existent model."""
        httpx_mock.add_response(
            method="GET",
            url="https://openrouter.ai/api/v1/models/nonexistent/model/providers",
            json={"providers": []},
            status_code=200
        )
    ...
    @pytest.mark.asyncio
    async def test_get_model_providers_empty_model_name(self, config):
    ...
    @pytest.mark.asyncio
    async def test_authentication_error_401(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_authentication_error_403(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_rate_limit_error_with_retry(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_rate_limit_error_max_retries(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_server_error_with_retry(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_server_error_max_retries(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_client_error_4xx(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_timeout_error_with_retry(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_timeout_error_max_retries(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_connection_error_with_retry(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_connection_error_max_retries(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_health_check_success(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_health_check_failure(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_health_check_exception(self, config, httpx_mock):
    ...
    @pytest.mark.asyncio
    async def test_exponential_backoff_delay_calculation(self, config):
    ...
    @pytest.mark.asyncio
    async def test_url_construction(self, config):
